...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="./img/logo_white.png" alt="" style="height: 9rem ; width: 10rem"/>
                        <h3>Welcome</h3>
                ...
                <div class="container content-sm " style="margin-top: 55px;">
	                    <div class="headline-center" style="margin-bottom: 60px; display:flex;justify-content:center">
                            <h2>ABOUT<span style="color: #72c02c;"> GLOBAL </span></h2>
                        </div>
                </div>
                
                <div class="container content" style="margin-top: 90px;color:white;ddis">
                        <div class="row" style="margin-bottom: 40px">
                        <div class="col-md-6" style="margin-bottom: 40px;">
                        <p><span style="color: #72c02c;">GLOBAL </span> Hospital  is a multi/super speciality hospital located at the prime location of Shillong, Meghalaya, INDIA; with state-of-the-art facilities & treatments at an affordable cost, encompassing wide spectrum of accurate diagnostics and elegant therapeutics created on the philosophical edifice of patient and ethical centricity ensuring humanistic dispensation.</p>
                        ...
                        <iframe style="height: 16rem;width:30rem" src="https://www.youtube.com/embed/ue7pfa7wcDg?autoplay=1&mute=1" allowFullScreen></iframe>
                        </div>
                        </div>
                        </div><!--/row-->
                </div>

                <div class="container content-sm aboutSection " style="color : white">
		    ...
		    <div class="container content-sm" style="color : #c3c3c3">
			<div class="headline-center" style="margin-bottom: 60px;">
				<h2 style="color : white">OUR DEPARTMENTS</h2>
				<div class="line"></div>
				<p >MEGA Hospital is spread over a massive 6 acre campus <br /> providing<strong> 300+ </strong> beds and
			...
			<div class="row" style="margin-bottom: 30px;">
				<div class="col-sm-6 " style="margin-bottom: 50px;">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">Cardiology</h3>
							<p>The department of cardiology at MEGA Hospital comprises of top cardiac experts who have
								appreciable experience in dealing with various types of cases in the cardiology and
								perform accurate diagnosis</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6" style="margin-bottom: 20px;">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">Dermatology and Cosmetology</h3>
							<p>The dermatology department of MEGA Hospital consists of a team of dermatologists and
								staff who are practicing in the field of dermatology and cosmetology for years and
								perform their best to treat the patients.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row " style="margin-bottom: 30px;">
				<div class="col-sm-6 " style="margin-bottom: 50px;">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">Emergency Care, CCU, & ICU</h3>
							<p>At MEGA Hospital, 24x7 care is provided to all our patients, keeping in mind patient
								dignity and ethical practice. Holistic care is ensured by our team of critical care
								experts who use a multidisciplinary approach.</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6" style="margin-bottom: 20px;">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">General Surgery</h3>
							<p>At MEGA Hospital, we have a team of experienced general surgeons who possess the skills
								to carry out the most complex surgeries.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px;">
				<div class="col-sm-6" style="margin-bottom: 50px;">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">Health Checkup Packages</h3>
							<p>MEGA Hospital provides health check up packages in Ahmedabad at very affordable price. As
								we aim at imbibing hope, health, and happiness in the community at large, our health
								check up packages in Ahmedabad help in early diagnosis.</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="service-block-v8">
						...
						<div class="service-block-desc">
							<h3 style="color : white">Neurology</h3>
							<p>The team at the Neurology department of MEGA Hospital comprises of highly-trained,
								skilled, and well-experienced team of Neurologists, Neurosurgeons, interventional
								radiologists, Neurophysiotherpists and rehabilitation teams who make sure that the
								patients receive the best quality treatments.</p>
						</div>
					</div>
				</div>
			</div>
